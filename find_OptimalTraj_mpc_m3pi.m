...
userInput = input('Type "yes" to run the user-interactive example.\nType "custom" to input STL specification. ', 's');
...
ds = 0.1; % time-step for running simulation
